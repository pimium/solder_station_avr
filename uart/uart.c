...
#error TX buffer size is not a power of 2
    ...
    defined(__AVR_AT90S8515__) || defined(__AVR_AT90S4434__) ||                \
...
#define UART0_BIT_UCSZ1 UCSZ1
    ...
    defined(__AVR_ATmega48PB__) || defined(__AVR_ATmega88__) ||                \
    ...
    defined(__AVR_ATmega3290__) || defined(__AVR_ATmega6450__) ||              \
...
#define UART0_BIT_UCSZ1 UCSZ1
    ...
    defined(__AVR_ATmega165__) || defined(__AVR_ATmega325__) ||                \
    defined(__AVR_ATmega645__) || defined(__AVR_ATmega3250__) ||               \
    defined(__AVR_ATmega6450__) || defined(__AVR_ATmega165A__) ||              \
    defined(__AVR_ATmega165PA__) || defined(__AVR_ATmega325A__) ||             \
    defined(__AVR_ATmega325PA__) || defined(__AVR_ATmega3250A__) ||            \
...
#define UART0_BIT_UCSZ1 UCSZ01
    ...
    defined(__AVR_ATmega128A__) || defined(__AVR_ATmega640__) ||               \
    defined(__AVR_ATmega1280__) || defined(__AVR_ATmega1281__) ||              \
    defined(__AVR_ATmega2560__) || defined(__AVR_ATmega2561__) ||              \
    defined(__AVR_ATmega164P__) || defined(__AVR_ATmega324P__) ||              \
    defined(__AVR_ATmega644P__) || defined(__AVR_ATmega164A__) ||              \
    defined(__AVR_ATmega164PA__) || defined(__AVR_ATmega324A__) ||             \
    defined(__AVR_ATmega324PA__) || defined(__AVR_ATmega644A__) ||             \
...
#define UART1_BIT_UCSZ1 UCSZ11
    ...
    defined(__AVR_ATmega32U2__) || defined(__AVR_ATmega16U4__) ||              \
    defined(__AVR_ATmega32U4__) || defined(__AVR_AT90USB82__) ||               \
    defined(__AVR_AT90USB162__) || defined(__AVR_AT90USB646__) ||              \
    defined(__AVR_AT90USB1286__) || defined(__AVR_AT90USB647__) ||             \
...
#warning "UART0_BIT_URSEL not defined"
  ...
  UART0_CONTROL =
      _BV(UART0_BIT_RXCIE) | (1 << UART0_BIT_RXEN) | (1 << UART0_BIT_TXEN);

/* Set frame format: asynchronous, 8data, no parity, 1stop bit */
#ifdef UART0_CONTROLC
#ifdef UART0_BIT_URSEL
  UART0_CONTROLC =
      (1 << UART0_BIT_URSEL) | (1 << UART0_BIT_UCSZ1) | (1 << UART0_BIT_UCSZ0);
#else
...
#warning "UART1_BIT_URSEL not defined"
  ...
  /* Enable USART receiver and transmitter and receive complete interrupt */
  UART1_CONTROL =
      _BV(UART1_BIT_RXCIE) | (1 << UART1_BIT_RXEN) | (1 << UART1_BIT_TXEN);

/* Set frame format: asynchronous, 8data, no parity, 1stop bit */
#ifdef UART1_BIT_URSEL
  UART1_CONTROLC =
      (1 << UART1_BIT_URSEL) | (1 << UART1_BIT_UCSZ1) | (1 << UART1_BIT_UCSZ0);
#else
