 ...
 *  the size of the circular buffers in bytes. Note that these constants must be
 * a power of 2.
 *  You may need to adapt these constants to your target and your application by
 * adding
 ...
 *
 *  You may need to adapt this constant to your target and your application by
 * adding
